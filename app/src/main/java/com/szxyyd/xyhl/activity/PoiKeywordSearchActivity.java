...
public class PoiKeywordSearchActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eywordsearch);
    ...
    public void onGeocodeSearched(GeocodeResult result, int rCode) {
        ...
        if (rCode == 1000) {
            if (result != null && result.getGeocodeAddressList() != null
                ...
                Toast.makeText(PoiKeywordSearchActivity.this,"addressName=="+addressName,Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(PoiKeywordSearchActivity.this,"没有数据",Toast.LENGTH_SHORT).show();

            }
        } else {
            Toast.makeText(PoiKeywordSearchActivity.this,"rCode=="+rCode,Toast.LENGTH_SHORT).show();
        }
    }
